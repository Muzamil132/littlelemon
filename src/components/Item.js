...
export const Item = () => {
  ...
  return (
    <div className='px-5 lg:px-[100px]   '>
        ...
        <h1 className='font-bold text-2xl '>This Weeks Specials</h1>
        <button className='btn btn-base rounded-full px-7'>Menu </button>
        </div>
        <div className='flex md:flex-row flex-col items-center  justify-center'>
            {
                foodData.map((item)=>(
        <div className="card rounded-lg mt-5 overflow-clip w-[300px] glass ml-4">
       <div className=''>
  ...
  <div className="card-body bg-base">
    ...
    <h5 className="card-title text-red-400">{item.price}</h5>
